...
\begin{center}
    ...
    Исаеву Арслану Эфлатановичу, % нужно указать в дательном падеже (задание кому?)
...
на тему «Разработка веб-приложения интернет-магазина спортивных товаров с
системой управления заказами и личными кабинетами пользователей»
...
\begin{longtable}{|P{0.5\textwidth}|C{0.11\textwidth}|C{0.15\textwidth}|C{0.24\textwidth}|}
    ...
    Задача 1.1. Обзор существующих интернет-магазинов спортивных товаров                             & 10                 & 22.03.2026    &                     \\ \hline
    ...
    Задача 2.1. Анализ целевой аудитории и требований к системе                                                             & 5                  & 02.04.2026    &                     \\ \hline
    ...
    Задача 3.3. Реализация системы проверки прав доступа         & 7                  & 03.05.2026    &                     \\ \hline
    Задача 3.4. Реализация CRUD-интерфейса для управления товарами и категориями                                           & 12                 & 09.05.2026    &                     \\ \hline
    Задача 3.5. Реализация агрегирования данных: статистика продаж, отчёты по заказам                                                  & 6                  & 15.05.2026    &                     \\ \hline
