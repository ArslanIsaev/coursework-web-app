...
% Определение данных
\newcommand{\theme}{%
    Разработка веб-приложения интернет-магазина спортивных товаров
с системой управления заказами и личными кабинетами пользователей%
}
\newcommand{\subject}{Разработка веб-приложений}
\newcommand{\student}{Исаев Арслан Эфлатанович}
